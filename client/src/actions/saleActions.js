//Define sale actions
import { GET_SALES, ADD_SALE, DELETE_SALE, SALES_LOADING, GET_SALE_BY_ID, UPDATE_SALE } from './types'
...
export const getSaleById = (id) => async (dispatch, getState) => {
    try {
        const response = await axios.get(`/api/sales/${id}`, tokenConfig(getState)) //Send the id as defined in our back end api
