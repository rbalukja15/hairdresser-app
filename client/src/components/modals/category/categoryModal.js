        ...
        return (
            <div>
                {this.props.isAuthenticated ? (
                    <Button color="success" outline style={{ marginBottom: '2rem' }} onClick={this.toggle.bind(this)}>
                        Shto Kategori
                    </Button>
                ) : (
...
export default connect(mapStateToProps, { addCategory })(CategoryModal) //Because we are using connect
