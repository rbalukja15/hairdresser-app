    ...
    return (
        <div>
            {props.isAuthenticated ? (
                <Button color="success" outline style={{ marginBottom: '2rem' }} onClick={toggle.bind(this)}>
                    Shto Event
                </Button>
            ) : (
...
export default connect(mapStateToProps, { getEvents, addEvent })(MaterialUIPickers) //Because we are using connect
